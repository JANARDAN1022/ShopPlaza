...
const Profile = () => {
  ...
  return (
    <div className="ProfileMainDiv">
          ...
          <div className="UserPasswordInfo">
            ...
            <div className="AccountInfo">
              ...
              <div className="UpdateInfo">
                <span onClick={() => setShowPasswordedit(true)}>
                  Update Password
                </span>
              </div>
            </div>
      ...
      <div
        className="PersonalUpdate"
        style={{ display: ShowPersonalEdit ? "" : "none" }}
      >
        <AiOutlineClose
          size={30}
          onClick={() => {
        ...
        <div className="PersonalEditContainer">
          ...
          <div className="UpdateProfilebtn">
            <button onClick={HandlePersonalUpdate}>
      ...
      <div
        ...
        style={{ display: ShowAccountEdit ? "" : "none" }}
      >
      ...
      <div
        ...
        style={{ display: ShowPasswordedit ? "" : "none" }}
      >
        <AiOutlineClose
          className="ClosePasswordedit"
          size={35}
          onClick={() => {
            setShowPasswordedit(false);
            setCurrentPassword("");
        ...
        <span
          className="PasswordEditerror"
          style={{ color: error !== "" ? "tomato" : "lightgreen" }}
        >
          {error !== "" ? error : Success}
        </span>
