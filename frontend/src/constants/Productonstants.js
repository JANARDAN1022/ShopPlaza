...
export const ALL_SIMILARCATEGORIES_REQUEST = 'ALL_SIMILARCATEGORIES_REQUEST';
export const ALL_SIMILARCATEGORIES_SUCCESS = 'ALL_SIMILARCATEGORIES_SUCCESS';
export const ALL_SIMILARCATEGORIES_FAIL = 'ALL_SIMILARCATEGORIES_FAIL';
